 ...
 * generated in the br.com.paulo.estudosws package. 
...
public class ObjectFactory {
    ...
    private final static QName _NextResponse_QNAME = new QName("http://estudosWS.paulo.com.br/", "nextResponse");
    private final static QName _Next_QNAME = new QName("http://estudosWS.paulo.com.br/", "next");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.com.paulo.estudosws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://estudosWS.paulo.com.br/", name = "nextResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://estudosWS.paulo.com.br/", name = "next")
