 ...
 * 
 */
@WebServiceClient(name = "RandomService", targetNamespace = "http://estudosWS.paulo.com.br/", wsdlLocation = "http://localhost:8080/random/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RANDOMSERVICE_QNAME = new QName("http://estudosWS.paulo.com.br/", "RandomService");
    ...
    public Random getRandomPort() {
        return super.getPort(new QName("http://estudosWS.paulo.com.br/", "RandomPort"), Random.class);
    }
    ...
    public Random getRandomPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://estudosWS.paulo.com.br/", "RandomPort"), Random.class, features);
    }
